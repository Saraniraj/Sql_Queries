USE  eSpin
GO
/****** Object:  UserDefinedFunction [dbo].[RG1_YarnStock_Abstract]    Script Date: 05-Jan-2023 15:16:37 ******/
SET ANSI_NULLS ON
GO
...
and a.Mix_Date between @Fromdate and @Todate   
and e.Sub_Count_code =@count
And a.delete_mode=0   
...
where  a.Location_Code =@location_code  
and a.Entry_Date  between @Fromdate and @Todate   
and e.Sub_Count_code =@count
And a.delete_mode=0   
group by a.Comp_code,a.Location_code,a.Fin_year_code 
